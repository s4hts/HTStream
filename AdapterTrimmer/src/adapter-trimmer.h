...
unsigned int checkIfOverlap(Read &r1, Read &r2, size_t loc1, size_t loc2, const double misDensity, size_t minOverlap, bool noFixBases = false ) {
...
unsigned int getOverlappedReads(Read &r1, Read &r2, const seqLookup &seq1Map,  const double misDensity, const size_t &minOver, const size_t &checkLengths, const size_t kmer, bool noFixBases = false ) {
    ...
    // if all we are doing is trimming adapters, why look for long inserts at all?
