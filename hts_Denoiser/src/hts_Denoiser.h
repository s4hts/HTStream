...
class Denoiser: public MainTemplate<TrimmingCounters, Denoiser> {
public:

    Denoiser() {
        program_name = "hts_Denoiser";
        app_description =
            "The hts_Denoiser application trims a set number of bases from the 5'\n";
