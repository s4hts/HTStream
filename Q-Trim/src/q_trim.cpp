...
int main(int argc, char** argv)
{
    ...
    try
    {
        ...
        desc.add_options()
            ...
            ("min-qual,t", po::value<size_t>(&min_qual)->default_value(10),    "Min base pairs trim for AT tail")
        ...
        try
        {
            ...
            min_qual += 33; // taking it from human input to ascii
            ...
            if(vm.count("read1-input")) {
                ...
                for(size_t i = 0; i < read1_files.size(); ++i) {
                    ...
                    helper_trim(ifp, pe, se, counters, min_length, min_qual, stranded, no_left, no_right);
                }
            }
            ...
            if(vm.count("singleend-input")) {
                ...
                for (auto file : read_files) {
                    ...
                    helper_trim(ifs, pe, se, counters, min_length, min_qual, stranded, no_left, no_right);
                }
            }
            ...
            if(vm.count("tab-input")) {
                ...
                for (auto file : read_files) {
                    ...
                    helper_trim(ift, pe, se, counters, min_length, min_qual, stranded, no_left, no_right);
                }
            }
