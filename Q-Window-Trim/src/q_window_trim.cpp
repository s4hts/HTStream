...
int main(int argc, char** argv)
{
    ...
    try
    {
        ...
        desc.add_options()
            ...
            ("no-orphans,n", po::bool_switch(&no_orphans)->default_value(false), "SE reads will not be written out")
        ...
        try
        {
            ...
            if(vm.count("read1-input")) {
                ...
                for(size_t i = 0; i < read1_files.size(); ++i) {
                    ...
                    helper_trim(ifp, pe, se, counters, min_length, sum_qual, window_size, stranded, no_left, no_right, no_orphans);
                }
            }
            ...
            if(vm.count("singleend-input")) {
                ...
                for (auto file : read_files) {
                    ...
                    helper_trim(ifs, pe, se, counters, min_length, sum_qual, window_size, stranded, no_left, no_right, no_orphans);
                }
            }
            ...
            if(vm.count("tab-input")) {
                ...
                for (auto file : read_files) {
                    ...
                    helper_trim(ift, pe, se, counters, min_length, sum_qual, window_size, stranded, no_left, no_right, no_orphans);
                }
            }
