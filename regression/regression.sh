...
testrun() {
    for prog in `find $BUILDDIR  -maxdepth 2 -name "hts*" -type f $findarg -not -name "*_test"`; do
        ...
        diff <(cat $out.json | jq -S "del(.[0].Program_details.version) | del(.[0].Program_details.options[\"stats-file\"]) | del(.[0].Program_details.options[\"tab-output\"])") \
            <(cat $orig.json | jq -S "del(.[0].Program_details.version) | del(.[0].Program_details.options[\"stats-file\"]) | del(.[0].Program_details.options[\"tab-output\"])")
        ...
        diff <(cat test/chain.json | jq -S "del(.[0].Program_details.version) | del(.[0].Program_details.options[\"stats-file\"]) | del(.[0].Program_details.options[\"append-stats-file\"]) | del(.[1].Program_details.version) | del(.[1].Program_details.options[\"stats-file\"]) | del(.[1].Program_details.options[\"append-stats-file\"])") \
            <(cat chain.json | jq -S "del(.[0].Program_details.version) | del(.[0].Program_details.options[\"stats-file\"]) | del(.[0].Program_details.options[\"append-stats-file\"]) | del(.[1].Program_details.version) | del(.[1].Program_details.options[\"stats-file\"]) | del(.[1].Program_details.options[\"append-stats-file\"])")
